...
function runtimer(){
  var timerFunction = setInterval(function(){
        if(timer > 0){
            ...
            document.querySelector("#p-bottom").innerHTML = `<h2 style="color: crimson; text-align: center">😣 OOPS ! <br> GAME OVER <br> <br> <span style = "color: green">Your Score is ${score}</span></h2>`
